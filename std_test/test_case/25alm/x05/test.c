...
void TASK1(VP_INT exinf)
{
	ER ercd ;
									_CHECK_STEP( 1 ) ;
	ercd = sta_alm( ERR_ALM_ID, DLYTIM_50 ) ;
									_CHECK_STEP( 2 ) ;
	_CHECK_ASSERT_E_ID( ercd ) ;
									_CHECK_STEP( 3 ) ;
#ifdef ERR_ERR_ALMTIM
	ercd = sta_alm( E_ALM_ID1, ERR_ALMTIM ) ;
									_CHECK_STEP( 4 ) ;
...
#endif
									_CHECK_STEP( 5 ) ;
	ercd = stp_alm( ERR_ALM_ID ) ;
									_CHECK_STEP( 6 ) ;
	_CHECK_ASSERT_E_ID( ercd ) ;
									_CHECK_STEP( 7 ) ;
	ercd = sta_alm( ALM_ID1, DLYTIM_50 ) ;
									_CHECK_STEP( 8 ) ;
	_CHECK_ASSERT_E_NOEXS( ercd ) ;
									_CHECK_STEP( 9 ) ;
	ercd = stp_alm( ALM_ID1 ) ;
									_CHECK_STEP( 10 ) ;
	_CHECK_ASSERT_E_NOEXS( ercd ) ;
									_CHECK_STEP( 11 ) ;
	...
	ercd = sta_alm( ALM_ID2, DLYTIM_100 ) ;
									_CHECK_STEP( 29 ) ;
	_CHECK_ASSERT_E_OK( ercd ) ;
									_CHECK_STEP( 30 ) ;
	ercd = stp_alm( ALM_ID1 ) ;
	...
	_CHECK_ASSERT_E_OK( ercd ) ;
									_CHECK_STEP( 34 ) ;
	_CHECK_ASSERT( alm_work2 == 0 ) ;
									_CHECK_STEP( 35 ) ;
	ercd = stp_alm( ALM_ID2 ) ;
									_CHECK_STEP( 36 ) ;
	_CHECK_ASSERT_E_OK( ercd ) ;
									_CHECK_STEP( 37 ) ;
