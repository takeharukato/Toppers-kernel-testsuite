...
void TASK1(VP_INT exinf)
{
	ER ercd;
									_CHECK_STEP( 1 ) ;
	ercd = cre_isr( ERR_ISR_ID, &e_cisr1 ) ;
									_CHECK_STEP( 2 ) ;
	...
	pk_cisr = ERR_POINTER ;
									_CHECK_STEP( 4 ) ;
	ercd = cre_isr( E_ISR_ID1, pk_cisr ) ;
									_CHECK_STEP( 5 ) ;
...
#endif
									_CHECK_STEP( 15 ) ;
	ercd = cre_isr( E_ISR_ID5, &e_cisr1 ) ;
									_CHECK_STEP( 16 ) ;
