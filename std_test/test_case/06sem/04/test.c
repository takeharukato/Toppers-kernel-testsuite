...
void TASK1(VP_INT exinf)
{
	...
	ER ercd ;
									_CHECK_STEP( 16 ) ;
	ercd = twai_sem( SEM_ID1, TMO_FEVR ) ;
									_CHECK_STEP( 29 ) ;
...
void TASK4(VP_INT exinf)
{
	ER ercd ;
									_CHECK_STEP( 1 ) ;
	ercd = twai_sem( ERR_SEM_ID, TMO_10 ) ;
									_CHECK_STEP( 2 ) ;
	_CHECK_ASSERT_E_ID( ercd ) ;
									_CHECK_STEP( 3 ) ;
	ercd = twai_sem( SEM_ID1, ERR_TMO ) ;
									_CHECK_STEP( 4 ) ;
	_CHECK_ASSERT_E_PAR( ercd ) ;
									_CHECK_STEP( 5 ) ;
	ercd = twai_sem( SEM_ID1, TMO_POL ) ;
									_CHECK_STEP( 6 ) ;
	_CHECK_ASSERT_E_OK( ercd ) ;
									_CHECK_STEP( 7 ) ;
	ercd = twai_sem( SEM_ID1, TMO_POL ) ;
