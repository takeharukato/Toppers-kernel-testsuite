...
void TASK4(VP_INT exinf)
{
	...
	VP blk, *p_blk = &blk ;
									_CHECK_STEP( 1 ) ;
	ercd = cre_mpl( ERR_MPL_ID, &k_cmpl2 ) ;
									_CHECK_STEP( 2 ) ;
	...
	pk_cmpl = ERR_POINTER ;
									_CHECK_STEP( 4 ) ;
	ercd = cre_mpl( E_MPL_ID1, pk_cmpl ) ;
									_CHECK_STEP( 5 ) ;
...
#endif
									_CHECK_STEP( 15 ) ;
	ercd = cre_mpl( E_MPL_ID5, &e_cmpl1 ) ;
									_CHECK_STEP( 16 ) ;
	_CHECK_ASSERT_E_NOMEM( ercd ) ;
									_CHECK_STEP( 17 ) ;
	ercd = cre_mpl( E_MPL_ID6, &k_cmpl2 ) ;
									_CHECK_STEP( 18 ) ;
	_CHECK_ASSERT_E_OK( ercd ) ;
									_CHECK_STEP( 19 ) ;
	ercd = cre_mpl( E_MPL_ID6, &k_cmpl2 ) ;
